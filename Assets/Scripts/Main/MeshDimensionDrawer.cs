...
public class MeshDimensionDrawer : MonoBehaviour
{
    ...
    private ResultText resultTextPrefab;
    ...
    public void DrawDimensions(GameObject meshObject, ResultText resultTextPrefab, ResultInfo resultInfo)
    {
        ...
        {
            case "XY":
                DrawLine(point_0, point_1, lrWidth, lrWidthCurve, leftBottom, leftBottom + new Vector3(size.x, 0, 0),
                    "x"); // X축 라인
                DrawLine(point_2, point_3, lrHeight, lrHeightCurve, leftBottom, leftBottom + new Vector3(0, size.y, 0),
                    "y"); // Y축 라인
                break;
            case "XZ":
                DrawLine(point_0, point_1, lrWidth, lrWidthCurve, leftBottom, leftBottom + new Vector3(size.x, 0, 0),
                    "x"); // X축 라인
                DrawLine(point_2, point_3, lrHeight, lrHeightCurve, leftBottom, leftBottom - new Vector3(0, 0, size.z),
                    "z"); // Z축 라인
                break;
            case "YZ":
                DrawLine(point_0, point_1, lrWidth, lrWidthCurve, leftBottom, leftBottom + new Vector3(0, size.y, 0),
                    "y"); // Y축 라인
                DrawLine(point_2, point_3, lrHeight, lrHeightCurve, leftBottom, leftBottom - new Vector3(0, 0, size.z),
                    "z"); // Z축 라인
                break;
    ...
    private void DrawLine(Transform pointA, Transform pointB, LineRenderer lineRenderer, LineRenderer lineCurve,
        Vector3 start, Vector3 end, string direction = "")
    {
